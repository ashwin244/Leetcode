...
public class CourseSchedule2 {
    ...
    public static void intializeGraph(int[] incomingLinkPerNode, List<List<Integer>> adjacentCourses, int[][] prerequisites) {
    ...
    public static int[] courseOrder(int[] incomingLinkPerNode, List<List<Integer>> adjacentCourses) {
    	int n = incomingLinkPerNode.length;
    	int[] order = new int[n];
